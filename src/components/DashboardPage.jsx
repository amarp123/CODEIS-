...
const GOOGLE_FORM_URL = "https://docs.google.com/forms/d/16wXu_T_Ei57hmPSAbwkTwBaGlILhEnwUOyWeODEdYEI/edit";
...
export default function DashboardPage() {
  ...
  const handleUpload = async () => {
    ...
    if (GOOGLE_FORM_URL === "https://docs.google.com/forms/d/16wXu_T_Ei57hmPSAbwkTwBaGlILhEnwUOyWeODEdYEI/edit") {
